"""
Test script that automatically finds an available port and runs a bot game.
"""
...
def find_free_port(start=8700, end=8800):
...
def spawn_bot_subprocess(room_id, bot_name, difficulty):
    ...
    # Override bot name and server URL in environment
    env = os.environ.copy()
